...
export interface ApiDisponibilidadDisponibilidad extends Schema.CollectionType {
  collectionName: 'disponibilidads';
  info: {
    singularName: 'disponibilidad';
    pluralName: 'disponibilidads';
  ...
  attributes: {
    ...
    laboratorio: Attribute.Relation<
...
export interface ApiLaboratorioLaboratorio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    capacidad: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<1>;
    descripcion: Attribute.String;
    equipos: Attribute.String;
    disponibilidads: Attribute.Relation<
      'api::laboratorio.laboratorio',
      'oneToMany',
      'api::disponibilidad.disponibilidad'
    >;
...
export interface ApiReservaReserva extends Schema.CollectionType {
  ...
  attributes: {
    ...
    start_time: Attribute.Time;
    end_time: Attribute.Time;
    estado: Attribute.Enumeration<['Confirmada', 'Cancelada', 'Pendiendte']>;
    laboratorio: Attribute.Relation<
      'api::reserva.reserva',
      'manyToOne',
      'api::laboratorio.laboratorio'
